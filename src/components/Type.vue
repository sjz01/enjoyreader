<template>
  <div id="type">
    ...
    <div class="typeTop">
      ...
      <router-link to="/more">
        <span
          @click="changeTitle('书城'),dj(key,1)"
          style="float:right;margin-right:14px;color:black; font-size: 16px;font-weight:400;"
        >更多></span>
      </router-link>
      <ul class="typeBook">
